...
class Elementor_Login_Logout_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'logged_out_section',
            [
                'label' => __('Logged Out (Not Logged In)', 'hello-elementor-child'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => get_permalink(get_option('woocommerce_myaccount_page_id')),
                'default' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .elementor-login-logout-widget' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-login-logout-widget' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-login-logout-widget a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-login-logout-widget a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .elementor-login-logout-widget .separator' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-login-logout-widget .separator' => 'margin: 0 {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $account_url = !empty($settings['account_url']['url']) ? $settings['account_url']['url'] : get_permalink(get_option('woocommerce_myaccount_page_id'));
        $logout_url = !empty($settings['logout_url']['url']) ? $settings['logout_url']['url'] : wp_logout_url(home_url());
        ...
        <div class="elementor-login-logout-widget">
            <?php if (is_user_logged_in()) : ?>
                ...
                if ($settings['show_username'] === 'yes') {
                    ...
                    echo '<span class="user-greeting">' . sprintf(__('Hello, %s', 'hello-elementor-child'), esc_html($current_user->display_name)) . '</span>';
    ...
    protected function content_template() {
        ...
        var accountUrl = settings.account_url.url ? settings.account_url.url : '<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>';
        var logoutUrl = settings.logout_url.url ? settings.logout_url.url : '<?php echo wp_logout_url(home_url()); ?>';
        var separator = settings.separator_text ? settings.separator_text : '|';
        #>
        <div class="elementor-login-logout-widget">
            <?php if (is_user_logged_in()) : ?>
                <# if (settings.show_username === 'yes') { #>
                    <span class="user-greeting"><?php echo sprintf(__('Hello, %s', 'hello-elementor-child'), wp_get_current_user()->display_name); ?></span>
