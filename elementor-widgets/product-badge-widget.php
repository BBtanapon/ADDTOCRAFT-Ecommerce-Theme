...
class Elementor_Product_Badge_Widget extends \Elementor\Widget_Base {
    ...
    public function get_keywords() {
        return ['product', 'badge', 'sale', 'tag', 'discount', 'woocommerce', 'label'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'percentage' => __('Percentage Discount', 'hello-elementor-child'),
                ],
                'condition' => [
                    'show_sale_badge' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => __('Use {percentage} as placeholder for discount value', 'hello-elementor-child'),
                'condition' => [
                    'show_sale_badge' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .product-badges-wrapper' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .product-badges-wrapper.position-top-left' => 'top: {{SIZE}}{{UNIT}}; left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .product-badges-wrapper.position-top-right' => 'top: {{SIZE}}{{UNIT}}; right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .product-badges-wrapper.position-bottom-left' => 'bottom: {{SIZE}}{{UNIT}}; left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .product-badges-wrapper.position-bottom-right' => 'bottom: {{SIZE}}{{UNIT}}; right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .badge-sale' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .badge-tag' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .badge-tag' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $discount_percentage = $is_on_sale ? $this->get_discount_percentage($product) : 0;
        ...
        <div class="product-badges-container">
            <?php foreach ($badges_by_position as $position => $badge_types) : ?>
                <div class="product-badges-wrapper position-<?php echo esc_attr($position); ?>">
                    <?php foreach ($badge_types as $badge_type) : ?>
    
                        <?php if ($badge_type === 'sale') : ?>
                            <?php
                            $hidden_class = (!$is_on_sale) ? 'badge-hidden' : 'badge-visible';
                            ?>
                            <span class="product-badge badge-sale <?php echo esc_attr($hidden_class); ?>">
                                <?php
                                if ($settings['sale_badge_type'] === 'percentage' && $is_on_sale) {
                                    $format = $settings['percentage_format'];
                                    echo esc_html(str_replace('{percentage}', $discount_percentage, $format));
                                } elseif ($is_on_sale) {
                        ...
                        <?php if ($badge_type === 'tag') : ?>
                            <?php
                            $hidden_class = (!$has_tags) ? 'badge-hidden' : 'badge-visible';
                            ?>
                            <span class="product-badge badge-tag <?php echo esc_attr($hidden_class); ?>">
                                <?php
                                if ($has_tags) {
